...
namespace CSharpModelsToJson.Tests
{
    ...
    {
        [Test]
        public void BasicEnumeration_ReturnSyntexEnumeration()
        {
            ...
            var modelCollector = new EnumerationCollector();
            modelCollector.Visit(root);

            Assert.IsNotNull(modelCollector.Enumerations);
            Assert.AreEqual("CardType", modelCollector.Enumerations.First().Identifier);
            Assert.AreEqual(3, modelCollector.Enumerations.First().Values.Count());
        }
